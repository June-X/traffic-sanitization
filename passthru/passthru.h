...
#define FILE_DEVICE_PASSTHRU 0x8e88

#define IOCTL_CMD_PASSTHRU_INTERNAL CTL_CODE(FILE_DEVICE_PASSTHRU, 0x1001, METHOD_NEITHER, FILE_ANY_ACCESS)
...
extern PMacNode MacListHead;

#define MACNODE_POOL_TAG "lcam"
//
...
extern NDIS_SPIN_LOCK	   MacListLock;
extern ULONG  time_per_tick;
extern PDRIVER_OBJECT PassthruDriver;
extern NDIS_HANDLE MiniportAdaptHandle;
